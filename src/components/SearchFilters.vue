  ...
  <section class=" bg-gray-800 xl:w-72">
    <div class="flex justify-between px-4 py-3 xl:hidden">
      <div class="relative max-w-xs w-full">
        <div class="absolute flex items-center inset-y-0 left-0 pl-3">
          ...
          <input class="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-3 py-2" placeholder="Search By Keyword">
      </div>
      <button @click="toggle" :class="{'bg-gray-600': isOpen,'bg-gray-700':!isOpen}" class=" ml-4 inline-flex bg-gray-700 hover:bg-gray-600 focus:outline-none focus:shadow-outline rounded-lg shadow pl-3 pr-4 pt-2">
    ...
    <form v-show="isOpen" class="xl:h-full xl:flex xl:flex-col xl:justify-between">
      <div class="lg:flex xl:block xl:overflow-y-auto">
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          ...
          <div class="sm:flex sm:-mx-2 lg:block lg:mx-0">
            <label class="flex mt-3 items-center sm:w-1/4 sm:px-2 lg:w-full lg:px-0">
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          ...
          <div class="sm:flex sm:flex-wrap sm:-mx-2">
            <label class="flex mt-3 items-center sm:w-1/4 sm:px-2 lg:w-1/2 lg:px-0  xl:w-full">
            ...
            <label class="flex mt-3 items-center sm:w-1/4 sm:px-2 lg:w-1/2 lg:px-0 xl:w-full">
              <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="kitFriendly">
              <span class="ml-2 text-white">Kid Friendly</span>
            </label>
            <label class="flex mt-3 items-center sm:w-1/2 sm:px-2 lg:w-full lg:px-0">
      ...
      <div class="px-4 py-4 bg-gray-900 sm:text-right">
        <button class=" block w-full sm:w-auto sm:inline-block px-4 py-2 bg-indigo-500 hover:bg-indigo-400 font-semibold text-white rounded-lg xl:block xl:w-full">Update Resultes</button>
      </div>
    </form>
